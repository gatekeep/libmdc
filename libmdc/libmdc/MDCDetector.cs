    ...
    public class MDCDetector : MDCCRC
    {
        ...
        public MDCDetector(int sampleRate)
        {
            ...
            else
            {
                ...
                this.incru = (uint)(1200 * 2 * (0x80000000 / sampleRate));
            }
                ...
                case 0:
                    {
                        ...
                        {
#if TRACE
                            System.Diagnostics.Trace.WriteLine("decoder " + idx + " sync " + gcount + " H:" + frames[idx].syncHigh.ToString("X") + " L:" + frames[idx].syncLow.ToString("X"));
#endif
                        ...
                        {
#if TRACE
                            System.Diagnostics.Trace.WriteLine("decoder " + idx + " isync " + gcount);
#endif
                            frames[idx].shstate = 1;
                            frames[idx].shcount = 0;
                            frames[idx].xorBit = !(frames[idx].xorBit);
        ...
        private bool ProcessBits(int idx)
        {
            ...
            if (ccrc == rcrc)
            {
                ...
                if (goodFrames > 0)
                {
                    ...
                    {
#if TRACE
                        System.Diagnostics.Trace.WriteLine("decoder " + idx + " Double Frame Message -- Waiting for Second Packet");
#endif
                        this.goodFrames = 0;
                        return true;
                    }
#if TRACE
                    System.Diagnostics.Trace.WriteLine("decoder " + idx + " Good Frames Count " + goodFrames);
                    System.Diagnostics.Trace.WriteLine("decoder " + idx + " MDC Frame 1 = " + ToString(first));

                    // if we have a frame count of > 1 then display second packet data
                    if (goodFrames > 1)
                        System.Diagnostics.Trace.WriteLine("decoder " + idx + " MDC Frame 2 = " + ToString(second));

                    System.Diagnostics.Trace.WriteLine("decoder " + idx + " MDC1200 packet [first (" + first.ToString() + ")], [second (" + second.ToString() + ")]");
#endif
                    // fire event
            ...
            {
#if TRACE
                System.Diagnostics.Trace.WriteLine("decoder " + idx + " CRC Mismatch! Bad MDC Frame " + goodFrames);
#endif
