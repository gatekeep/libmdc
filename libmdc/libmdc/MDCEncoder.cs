    ...
    public class MDCEncoder : MDCCRC
    {
        ...
        public MDCEncoder(int sampleRate)
        {
            ...
            else
            {
                ...
                this.incru18 = (uint)(1800 * 2 * (0x80000000 / sampleRate));
            }
        ...
        {
#if TRACE
            System.Diagnostics.Trace.WriteLine("creating single-length MDC1200 packet [first [" + packet.ToString() + ")]");
#endif
        ...
        {
#if TRACE
            System.Diagnostics.Trace.WriteLine("creating double-length MDC1200 packet [first (" + first.ToString() + ")], [second (" + second.ToString() + ")]");
#endif
            // initialize MDC1200 header
            if (noPreamble)
        ...
        {
            byte[] tmpBuffer = new byte[131072];
