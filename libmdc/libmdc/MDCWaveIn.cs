    ...
    public class MDCWaveIn : IDisposable
    {
        ...
        public void ProcessSamples(byte[] buffer, bool eightBitConvert = false)
        {
            if (eightBitConvert)
            {
                ...
                int len = SamplesToMS.MSToSampleBytes(toFormat, (int)reader.TotalTime.TotalMilliseconds);
        ...
        {
            sourceBuffer = new AudioWaveProvider(source.WaveFormat) { DiscardOnBufferOverflow = true };
